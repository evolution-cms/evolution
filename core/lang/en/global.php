...
$_lang["chunk_assigned_file"] = 'Corresponding chunk file';
$_lang["chunk_file_unusable_name"] = 'this name cannot become a filename';
$_lang["chunk_file_not_writable"] = 'The chunk file %s could not be written, so nothing was saved. Check the name and the permissions of the chunk directory.';
$_lang["chunk_name_empty"] = 'A chunk kept in a file needs a name.';
$_lang["chunk_name_not_utf8"] = 'This name is not valid UTF-8, so it cannot become a filename.';
$_lang["chunk_name_not_nfc"] = 'This name uses combining characters. Retype it, or macOS will treat it as the same file as another spelling of the same word.';
$_lang["chunk_name_too_long"] = 'This name is too long to be a filename once its special characters are escaped.';
$_lang["chunk_name_collides"] = 'This name and the chunk "%s" would share one file on Windows and macOS, which tell them apart only by case. Rename one of them.';
...
$_lang["template_assigned_file"] = 'Corresponding template file';
$_lang["template_create_file"] = 'Create template file on save';
$_lang["template_file_exists"] = 'Already on disk';
$_lang["template_source_discard_edits"] = 'The editor has unsaved changes. Switching loads the other copy and discards them. Continue?';
$_lang["template_file_pending"] = 'named after the alias, once there is one';
$_lang["template_file_not_writable"] = 'The template file %s could not be written, so nothing was saved. Check the alias and the permissions of the views directory.';
$_lang["template_source"] = 'Template code';
$_lang["template_source_db"] = 'In the database';
$_lang["template_source_file"] = 'In a file';
$_lang["template_source_auto"] = 'Automatic (a matching file wins)';
$_lang["template_source_to_file"] = 'What is in the editor is written to the file on save. The database copy is kept as it is.';
$_lang["template_source_back_to_db"] = 'The editor now shows the database copy, and that is what will be saved. The file is left where it is.';
$_lang["template_file_already_exists"] = 'This file already exists and is left untouched on save.';
$_lang["template_file_shadowed"] = 'Until this template is saved, this file still renders:';
$_lang["template_file_wins"] = 'this one renders';
$_lang["template_selectable"] = 'Template selectable when creating or editing resources.';
