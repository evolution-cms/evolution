...
$_lang["chunk_assigned_file"] = 'Bijbehorend Chunk-bestand';
$_lang["chunk_file_unusable_name"] = 'deze naam kan geen bestandsnaam worden';
$_lang["chunk_file_not_writable"] = 'Het Chunk-bestand %s kon niet worden geschreven, dus er is niets opgeslagen. Controleer de naam en de rechten van de Chunk-map.';
$_lang["chunk_name_empty"] = 'Een Chunk die in een bestand staat, heeft een naam nodig.';
$_lang["chunk_name_not_utf8"] = 'Deze naam is geen geldige UTF-8 en kan dus geen bestandsnaam worden.';
$_lang["chunk_name_not_nfc"] = 'Deze naam gebruikt combinerende tekens. Typ hem opnieuw, anders behandelt macOS hem als hetzelfde bestand als een andere schrijfwijze van hetzelfde woord.';
$_lang["chunk_name_too_long"] = 'Deze naam is te lang voor een bestandsnaam zodra de speciale tekens zijn geëscaped.';
$_lang["chunk_name_collides"] = 'Deze naam en de Chunk "%s" zouden op Windows en macOS één bestand delen; die onderscheiden ze alleen op hoofdletters. Hernoem er een.';
