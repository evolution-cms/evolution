...
$_lang["rb_webuser_message"] = 'Хотите ли вы, чтобы веб-пользователи использовали файл-менеджер? <b>Примечание:</b> Позволяя веб-пользователям использовать файл-менеджер, вы делаете доступ для всех файлов, которые доступны менеджерам. Используйте эту настройку только для проверенных веб-пользователей.';
...
$_lang["setting_resource_tree_node_name_desc_add"] = 'Примечание: Начиная с версии MODX Evolution 1.1 Вы можете изменить отображаемое имя ресурса через опцию \'Сортировать дерево\'. Этот параметр используется, если отображаемое имя в дереве ресурсов устанавливается на \'По-умолчанию\'.';
...
$_lang["cm_x_assigned_to_category_y"] = "<b>%s (%s)</b> присвоено категории <b>%s (%s)</b>";
