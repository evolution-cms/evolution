...
$_lang["chunk_assigned_file"] = 'Відповідний файл чанка';
$_lang["chunk_file_unusable_name"] = 'це ім\'я не може стати іменем файлу';
$_lang["chunk_file_not_writable"] = 'Не вдалося записати файл чанка %s, тому нічого не збережено. Перевірте ім\'я і права на каталог чанків.';
$_lang["chunk_name_empty"] = 'Чанк, що зберігається у файлі, потребує імені.';
$_lang["chunk_name_not_utf8"] = 'Це ім\'я не є коректним UTF-8, тому не може стати іменем файлу.';
$_lang["chunk_name_not_nfc"] = 'В імені є комбіновані символи. Наберіть його заново, інакше macOS вважатиме його тим самим файлом, що й інший запис того самого слова.';
$_lang["chunk_name_too_long"] = 'Ім\'я задовге, щоб стати іменем файлу після екранування спецсимволів.';
$_lang["chunk_name_collides"] = 'Це ім\'я і чанк «%s» ділили б один файл на Windows і macOS — вони розрізняють імена без урахування регістру. Перейменуйте одне з них.';
...
$_lang["module_exec_no_privileges"] = 'У вас недостатньо прав для запуску цього модуля.';
$_lang["module_exec_not_found"] = 'Модуль з id %s не знайдено.';
$_lang["module_exec_disabled"] = 'Цей модуль вимкнено, і його не можна запустити.';
...
$_lang["resource_save_unconfirmed"] = 'Збереження не підтверджено. Редактор перезавантажиться, щоб показати збережений стан.';
...
$_lang["template_assigned_file"] = 'Відповідний файл шаблону';
$_lang["template_create_file"] = 'Створити файл шаблону при збереженні';
$_lang["template_file_exists"] = 'Вже на диску';
$_lang["template_source_discard_edits"] = 'У редакторі є незбережені зміни. Перемикання завантажить іншу копію і відкине їх. Продовжити?';
$_lang["template_file_pending"] = 'буде названий за псевдонімом, коли він з\'явиться';
$_lang["template_file_not_writable"] = 'Не вдалося записати файл шаблону %s, тому нічого не збережено. Перевірте псевдонім і права на каталог views.';
$_lang["template_source"] = 'Код шаблону';
$_lang["template_source_db"] = 'У базі даних';
$_lang["template_source_file"] = 'У файлі';
$_lang["template_source_auto"] = 'Автоматично (перемагає відповідний файл)';
$_lang["template_source_to_file"] = 'Вміст редактора під час збереження записується у файл. Копія в базі даних лишається без змін.';
$_lang["template_source_back_to_db"] = 'У редакторі тепер копія з бази даних — саме її буде збережено. Файл залишиться на місці.';
$_lang["template_file_already_exists"] = 'Цей файл уже існує і під час збереження не змінюється.';
$_lang["template_file_shadowed"] = 'Поки шаблон не збережено, відображається цей файл:';
$_lang["template_file_wins"] = 'використовується цей';
...
$_lang['email_method_message'] = 'Спосіб відправки системних листів. Варіант із функцією mail() передає лист локальній поштовій програмі сервера і не потребує додаткового налаштування. «Через SMTP-сервер» відправляє через зовнішній SMTP-сервер, налаштований нижче, і це єдиний режим, у якому автовизначення відправника може використати ім’я користувача SMTP.';
$_lang['smtp_auth_title'] = 'SMTP авторизація';
$_lang['smtp_autotls_title'] = 'SMTPAutoTLS';
$_lang['smtp_verify_peer_title'] = 'Перевіряти TLS-сертифікат SMTP';
$_lang['smtp_verify_peer_message'] = 'Перевіряє чинність сертифіката та відповідність імені SMTP-сервера. Вимикайте лише тимчасово: це послаблює захист з’єднання.';
...
$_lang["docid_incrmnt_method_title"] = 'Спосіб додавання ID ресурсу';
...
$_lang['email_sender_method_message'] = '«Автовизначення»: якщо вибрано SMTP і ім’я користувача SMTP є коректною email-адресою, воно використовується і як адреса From, і як відправник конверта. Інакше для From використовується [(emailsender)], а відправник конверта залишається на попередній автоматичній обробці транспортом. «Використовуйте значення [(emailsender)]» примусово задає цю адресу і для From, і для відправника конверта.';
...
$_lang['mail_test_error_certificate_expired'] = 'TLS-сертифікат SMTP прострочений. Термін його дії завершився :date.';
