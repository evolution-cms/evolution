...
$evo_lang_attribute = 'it'; // Manager HTML/XML Language Attribute see http://en.wikipedia.org/wiki/ISO_639-1
...
$_lang["chunk_assigned_file"] = 'File del Chunk corrispondente';
$_lang["chunk_file_unusable_name"] = 'questo nome non può diventare un nome di file';
$_lang["chunk_file_not_writable"] = 'Non è stato possibile scrivere il file del Chunk %s, quindi non è stato salvato nulla. Controlla il nome e i permessi della cartella dei Chunk.';
$_lang["chunk_name_empty"] = 'Un Chunk conservato in un file ha bisogno di un nome.';
$_lang["chunk_name_not_utf8"] = 'Questo nome non è UTF-8 valido, quindi non può diventare un nome di file.';
$_lang["chunk_name_not_nfc"] = 'Questo nome usa caratteri combinanti. Riscrivilo, altrimenti macOS lo tratterà come lo stesso file di un\'altra grafia della stessa parola.';
$_lang["chunk_name_too_long"] = 'Questo nome è troppo lungo per un nome di file una volta che i caratteri speciali sono stati preceduti da escape.';
$_lang["chunk_name_collides"] = 'Questo nome e il Chunk «%s» condividerebbero un unico file su Windows e macOS, che li distinguono solo per maiuscole e minuscole. Rinomina uno dei due.';
