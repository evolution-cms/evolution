...
$_lang["chunk_assigned_file"] = 'Fichier du Chunk correspondant';
$_lang["chunk_file_unusable_name"] = 'ce nom ne peut pas devenir un nom de fichier';
$_lang["chunk_file_not_writable"] = 'Le fichier du Chunk %s n\'a pas pu être écrit, rien n\'a donc été enregistré. Vérifiez le nom et les droits du répertoire des Chunks.';
$_lang["chunk_name_empty"] = 'Un Chunk conservé dans un fichier a besoin d\'un nom.';
$_lang["chunk_name_not_utf8"] = 'Ce nom n\'est pas de l\'UTF-8 valide, il ne peut donc pas devenir un nom de fichier.';
$_lang["chunk_name_not_nfc"] = 'Ce nom utilise des caractères combinants. Ressaisissez-le, sinon macOS le traitera comme le même fichier qu\'une autre graphie du même mot.';
$_lang["chunk_name_too_long"] = 'Ce nom est trop long pour un nom de fichier une fois ses caractères spéciaux échappés.';
$_lang["chunk_name_collides"] = 'Ce nom et le Chunk « %s » partageraient un même fichier sous Windows et macOS, qui ne les distinguent que par la casse. Renommez l\'un des deux.';
