...
$_lang = [
  ...
  'cant_write_config_file_retry' => 'Varmista, että PHP voi lukea ja kirjoittaa määritystiedostoa. Suositellut oikeudet ovat tiedostolle <code>0644 (rw-r--r--)</code> ja hakemistolle <code>/core/config/database/connections/</code> <code>0755 (rwxr-xr-x)</code>. Tiedosto ei tarvitse suoritusoikeutta. Älä käytä oikeuksia <code>0777</code>, ellei palveluntarjoajasi sitä nimenomaisesti vaadi. Yritä sitten asennusta uudelleen.',
  ...
  'checking_if_database_config_writable' => 'Tarkistetaan oikeudet luettavan määritystiedoston <code>/core/config/database/connections/default.php</code> luomiseen tai päivittämiseen: ',
  ...
  'status_failed_database_collation_does_not_match' => 'epäonnistui - tietokannan lajittelu ei täsmää (palvelimen oletus on %1$s). Suositus: muuta tietokannan lajittelu hosting-paneelissa/phpMyAdminissa vastaamaan valittua UTF-8-lajittelua ja suorita tarkistus uudelleen. Jos SET NAMES on tuettu, voit jatkaa; älä vaihda arvoon %1$s vain tämän tarkistuksen läpäisemiseksi.',
