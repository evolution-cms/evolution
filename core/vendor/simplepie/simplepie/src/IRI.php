...
class IRI
{
    ...
    protected function scheme_normalization()
    {
        ...
        if (isset($this->normalization[$scheme]['iuserinfo']) && $this->iuserinfo === $this->normalization[$scheme]['iuserinfo']) {
            $this->iuserinfo = null;
        }
        if (isset($this->normalization[$scheme]['ihost']) && $this->ihost === $this->normalization[$scheme]['ihost']) {
            $this->ihost = null;
        }
        if (isset($this->normalization[$scheme]['port']) && $this->port === $this->normalization[$scheme]['port']) {
            $this->port = null;
        }
        if (isset($this->normalization[$scheme]['ipath']) && $this->ipath === $this->normalization[$scheme]['ipath']) {
            $this->ipath = '';
        }
        if (isset($this->normalization[$scheme]['iquery']) && $this->iquery === $this->normalization[$scheme]['iquery']) {
            $this->iquery = null;
        }
        if (isset($this->normalization[$scheme]['ifragment']) && $this->ifragment === $this->normalization[$scheme]['ifragment']) {
            $this->ifragment = null;
        }
    }
