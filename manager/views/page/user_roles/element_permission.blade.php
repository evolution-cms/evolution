        ...
        <div class="rTableRow">
            ...
            <div class="btnCell">
                <ul class="elements_buttonbar">
                    ...
                    <li>
                        <a href="{{ $item->makeUrl('actions.delete') }}&action=delete&_token={{ csrf_token() }}" title="{{ ManagerTheme::getLexicon('delete') }}" onclick="return confirm('{{ ManagerTheme::getLexicon('confirm_delete') }}')">
