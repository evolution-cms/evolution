...
$evo_lang_attribute = 'pl'; // Manager HTML/XML Language Attribute see http://en.wikipedia.org/wiki/ISO_639-1
...
$_lang["chunk_assigned_file"] = 'Odpowiadający plik chunka';
$_lang["chunk_file_unusable_name"] = 'ta nazwa nie może stać się nazwą pliku';
$_lang["chunk_file_not_writable"] = 'Nie udało się zapisać pliku chunka %s, więc nic nie zostało zapisane. Sprawdź nazwę i uprawnienia katalogu chunków.';
$_lang["chunk_name_empty"] = 'Chunk przechowywany w pliku potrzebuje nazwy.';
$_lang["chunk_name_not_utf8"] = 'Ta nazwa nie jest poprawnym UTF-8, więc nie może stać się nazwą pliku.';
$_lang["chunk_name_not_nfc"] = 'Ta nazwa używa znaków składających. Wpisz ją ponownie, inaczej macOS potraktuje ją jak ten sam plik co inny zapis tego samego słowa.';
$_lang["chunk_name_too_long"] = 'Ta nazwa jest za długa na nazwę pliku po zamianie znaków specjalnych na sekwencje.';
$_lang["chunk_name_collides"] = 'Ta nazwa i chunk „%s” dzieliłyby jeden plik w systemach Windows i macOS, które rozróżniają je tylko wielkością liter. Zmień nazwę jednego z nich.';
...
$_lang['time_unit_hour_short'] = 'godz';
