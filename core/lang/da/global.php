...
$_lang["chunk_assigned_file"] = 'Tilhørende chunk-fil';
$_lang["chunk_file_unusable_name"] = 'dette navn kan ikke blive et filnavn';
$_lang["chunk_file_not_writable"] = 'Chunk-filen %s kunne ikke skrives, så intet blev gemt. Kontrollér navnet og rettighederne til chunk-mappen.';
$_lang["chunk_name_empty"] = 'En chunk, der gemmes i en fil, skal have et navn.';
$_lang["chunk_name_not_utf8"] = 'Dette navn er ikke gyldig UTF-8 og kan derfor ikke blive et filnavn.';
$_lang["chunk_name_not_nfc"] = 'Dette navn bruger kombinerende tegn. Skriv det igen, ellers behandler macOS det som samme fil som en anden stavemåde af samme ord.';
$_lang["chunk_name_too_long"] = 'Dette navn er for langt til et filnavn, når dets specialtegn er escapet.';
$_lang["chunk_name_collides"] = 'Dette navn og chunken "%s" ville dele én fil på Windows og macOS, som kun skelner dem ved store og små bogstaver. Omdøb en af dem.';
