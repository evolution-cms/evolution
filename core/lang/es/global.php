...
$_lang["chunk_assigned_file"] = 'Archivo de chunk correspondiente';
$_lang["chunk_file_unusable_name"] = 'este nombre no puede ser un nombre de archivo';
$_lang["chunk_file_not_writable"] = 'No se pudo escribir el archivo de chunk %s, por lo que no se guardó nada. Compruebe el nombre y los permisos del directorio de chunks.';
$_lang["chunk_name_empty"] = 'Un chunk guardado en un archivo necesita un nombre.';
$_lang["chunk_name_not_utf8"] = 'Este nombre no es UTF-8 válido, por lo que no puede ser un nombre de archivo.';
$_lang["chunk_name_not_nfc"] = 'Este nombre usa caracteres combinantes. Vuelva a escribirlo o macOS lo tratará como el mismo archivo que otra escritura de la misma palabra.';
$_lang["chunk_name_too_long"] = 'Este nombre es demasiado largo para un nombre de archivo una vez escapados sus caracteres especiales.';
$_lang["chunk_name_collides"] = 'Este nombre y el chunk «%s» compartirían un mismo archivo en Windows y macOS, que solo los distinguen por mayúsculas y minúsculas. Cambie el nombre de uno de ellos.';
