...
$_lang["chunk_assigned_file"] = 'Tilhøyrande htmlstykke-fil';
$_lang["chunk_file_unusable_name"] = 'dette namnet kan ikkje bli eit filnamn';
$_lang["chunk_file_not_writable"] = 'Htmlstykke-fila %s kunne ikkje skrivast, så ingenting vart lagra. Kontroller namnet og rettane til htmlstykke-katalogen.';
$_lang["chunk_name_empty"] = 'Eit htmlstykke som ligg i ei fil, treng eit namn.';
$_lang["chunk_name_not_utf8"] = 'Dette namnet er ikkje gyldig UTF-8, og kan difor ikkje bli eit filnamn.';
$_lang["chunk_name_not_nfc"] = 'Dette namnet brukar kombinerande teikn. Skriv det inn på nytt, elles handsamar macOS det som same fila som ei anna skrivemåte av same ordet.';
$_lang["chunk_name_too_long"] = 'Dette namnet er for langt til eit filnamn når spesialteikna er escapa.';
$_lang["chunk_name_collides"] = 'Dette namnet og htmlstykket «%s» ville dele éi fil på Windows og macOS, som berre skil dei med store og små bokstavar. Gi eitt av dei nytt namn.';
