...
$evo_lang_attribute = 'de'; // Manager HTML/XML Language Attribute see http://en.wikipedia.org/wiki/ISO_639-1
...
$_lang["chunk_assigned_file"] = 'Zugehörige Chunk-Datei';
$_lang["chunk_file_unusable_name"] = 'dieser Name kann kein Dateiname werden';
$_lang["chunk_file_not_writable"] = 'Die Chunk-Datei %s konnte nicht geschrieben werden, daher wurde nichts gespeichert. Prüfen Sie den Namen und die Rechte des Chunk-Verzeichnisses.';
$_lang["chunk_name_empty"] = 'Ein Chunk, der in einer Datei liegt, braucht einen Namen.';
$_lang["chunk_name_not_utf8"] = 'Dieser Name ist kein gültiges UTF-8 und kann daher kein Dateiname werden.';
$_lang["chunk_name_not_nfc"] = 'Dieser Name enthält kombinierende Zeichen. Geben Sie ihn neu ein, sonst behandelt macOS ihn als dieselbe Datei wie eine andere Schreibweise desselben Wortes.';
$_lang["chunk_name_too_long"] = 'Dieser Name ist zu lang für einen Dateinamen, sobald seine Sonderzeichen maskiert sind.';
$_lang["chunk_name_collides"] = 'Dieser Name und der Chunk „%s“ würden sich unter Windows und macOS eine Datei teilen, die nur nach Groß- und Kleinschreibung unterscheiden. Benennen Sie einen von beiden um.';
...
$_lang["resource_weblink_help"] = 'Geben Sie hier die Adresse des Objektes ein, welches Sie mit dem Weblink verlinken möchten. Alternativ können Sie den Datei-Browser verwenden, oder klicken Sie auf das Icon und wählen Sie eine Ressource aus dem Ressourcen-Baum.';
...
$_lang["template_selectable"] = 'Template ist auswählbar, wenn eine Ressource erstellt oder bearbeitet wird.';
...
$_lang["use_breadcrumbs_message"] = 'Zeigt einen Brotkrumenpfad an wenn eine Ressource erstellt oder bearbeitet wird.';
...
$_lang['time_unit_day_short'] = 'T';
$_lang['time_unit_hour_short'] = 'Std';
