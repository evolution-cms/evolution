...
$_lang["tmplvars_binding_msg"] = 'Məlumat bağlantısını seçmək üçün @ yazın';
...
$_lang["files_download_zip"] = 'ZIP yüklə';
$_lang["files_delete_zip"] = 'ZIP-i sil';
...
$_lang["page_data_scheduled_publishdate"] = 'Planlaşdırılmış dərc tarixi';
$_lang["page_data_scheduled_publishdate_help"] = 'Planlaşdırılmış dərc tarixi təyin etsəniz, resurs həmin tarix çatanda dərc olunacaq. Avtomatik dərc planlaşdırmamaq üçün boş saxlayın.';
$_lang["page_data_actual_publishdate"] = 'Faktiki dərc tarixi';
$_lang["page_data_actual_publishdate_help"] = 'publishedon daxilində saxlanan yalnız oxunan vaxt göstəricisi. Resursun faktiki nə vaxt dərc edildiyini göstərir.';
...
$_lang["site_timezone_title"] = 'Saytın saat qurşağı';
$_lang["site_timezone_message"] = 'IANA saat qurşağını seçin. O, PHP və tətbiq üçün istifadə edilir və yay vaxtını avtomatik nəzərə alır.';
$_lang["serveroffset_deprecated_message"] = '<b>Köhnəlib:</b> bu sabit fərq uyğunluq üçün saxlanılır və yay vaxtını nəzərə almır. Saytın saat qurşağına üstünlük verin.';
...
$_lang["hide_from_tree_title"] = 'Alt resursları göstər';
$_lang["hide_from_tree_help"] = 'Sənəd ağacında alt resursları göstərmək üçün işarələyin';
...
$_lang['mail_test_subject'] = ':site saytından :destination ünvanına test mesajı';
$_lang['mail_test_automated_note'] = 'Bu avtomatik test mesajıdır. Cavab tələb olunmur.';
