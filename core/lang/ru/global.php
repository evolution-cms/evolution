...
$_lang["chunk_assigned_file"] = 'Соответствующий файл чанка';
$_lang["chunk_file_unusable_name"] = 'это имя не может стать именем файла';
$_lang["chunk_file_not_writable"] = 'Не удалось записать файл чанка %s, поэтому ничего не сохранено. Проверьте имя и права на каталог чанков.';
$_lang["chunk_name_empty"] = 'Чанку, который хранится в файле, нужно имя.';
$_lang["chunk_name_not_utf8"] = 'Это имя не является корректным UTF-8, поэтому не может стать именем файла.';
$_lang["chunk_name_not_nfc"] = 'В имени есть комбинированные символы. Наберите его заново, иначе macOS сочтёт его тем же файлом, что и другую запись того же слова.';
$_lang["chunk_name_too_long"] = 'Имя слишком длинное, чтобы стать именем файла после экранирования спецсимволов.';
$_lang["chunk_name_collides"] = 'Это имя и чанк «%s» делили бы один файл на Windows и macOS — они различают имена без учёта регистра. Переименуйте одно из них.';
...
$_lang["template_assigned_file"] = 'Соответствующий файл шаблона';
$_lang["template_create_file"] = 'Создать файл шаблона при сохранении';
$_lang["template_file_exists"] = 'Уже на диске';
$_lang["template_source_discard_edits"] = 'В редакторе есть несохранённые изменения. Переключение загрузит другую копию и отбросит их. Продолжить?';
$_lang["template_file_pending"] = 'будет назван по псевдониму, когда он появится';
$_lang["template_file_not_writable"] = 'Не удалось записать файл шаблона %s, поэтому ничего не сохранено. Проверьте псевдоним и права на каталог views.';
$_lang["template_source"] = 'Код шаблона';
$_lang["template_source_db"] = 'В базе данных';
$_lang["template_source_file"] = 'В файле';
$_lang["template_source_auto"] = 'Автоматически (побеждает подходящий файл)';
$_lang["template_source_to_file"] = 'Содержимое редактора при сохранении записывается в файл. Копия в базе данных остаётся без изменений.';
$_lang["template_source_back_to_db"] = 'В редакторе теперь копия из базы данных — она и будет сохранена. Файл останется на месте.';
$_lang["template_file_already_exists"] = 'Этот файл уже существует и при сохранении не изменяется.';
$_lang["template_file_shadowed"] = 'Пока шаблон не сохранён, отображается этот файл:';
$_lang["template_file_wins"] = 'используется этот';
...
$_lang['smtp_verify_peer_title'] = 'Проверять TLS-сертификат SMTP';
$_lang['smtp_verify_peer_message'] = 'Проверяет срок действия сертификата и соответствие имени SMTP-сервера. Отключайте только временно: это ослабляет защиту соединения.';
...
$_lang["docid_incrmnt_method_title"] = 'Способ добавления ID ресурса';
...
$_lang["role_modules_msg"] = 'Модули, которые разрешено запускать этой роли. Модуль без ограничений доступен всем ролям — снимите галочку, чтобы ограничить его.';
$_lang["role_modules_admin_msg"] = 'Роль администратора может запускать любые модули.';
$_lang["role_modules_none"] = 'Модули ещё не установлены.';
...
$_lang['mail_test_error_certificate_expired'] = 'TLS-сертификат SMTP просрочен. Срок его действия истёк :date.';
