...
$evo_lang_attribute = 'sv'; // Manager HTML/XML Language Attribute see http://en.wikipedia.org/wiki/ISO_639-1
...
$_lang["chunk_assigned_file"] = 'Motsvarande chunk-fil';
$_lang["chunk_file_unusable_name"] = 'det här namnet kan inte bli ett filnamn';
$_lang["chunk_file_not_writable"] = 'Chunk-filen %s kunde inte skrivas, så ingenting sparades. Kontrollera namnet och rättigheterna för chunk-katalogen.';
$_lang["chunk_name_empty"] = 'En chunk som sparas i en fil behöver ett namn.';
$_lang["chunk_name_not_utf8"] = 'Det här namnet är inte giltig UTF-8 och kan därför inte bli ett filnamn.';
$_lang["chunk_name_not_nfc"] = 'Det här namnet använder kombinerande tecken. Skriv det igen, annars behandlar macOS det som samma fil som en annan stavning av samma ord.';
$_lang["chunk_name_too_long"] = 'Det här namnet är för långt för ett filnamn när specialtecknen har escapats.';
$_lang["chunk_name_collides"] = 'Det här namnet och chunken ”%s” skulle dela samma fil på Windows och macOS, som bara skiljer dem åt med versaler och gemener. Byt namn på en av dem.';
...
$_lang["module_exec_no_privileges"] = 'Du har inte tillräcklig behörighet för att köra den här modulen.';
$_lang["module_exec_not_found"] = 'Ingen modul hittades med id %s.';
$_lang["module_exec_disabled"] = 'Den här modulen är inaktiverad och kan inte köras.';
...
$_lang["role_modules_msg"] = 'Moduler som den här rollen får köra. En modul som ingen har begränsat är tillgänglig för alla roller — att avmarkera den här är det som begränsar den.';
$_lang["role_modules_admin_msg"] = 'Administratörsrollen kan köra alla moduler.';
$_lang["role_modules_none"] = 'Inga moduler är installerade ännu.';
...
$_lang['time_unit_hour_short'] = 'tim';
