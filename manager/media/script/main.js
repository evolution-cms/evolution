...
function document_onload() {
    ...
    if (actionButtons !== null && actionSelect !== null) {
        ...
        if (actionSelect.value) {
            actionSaveButton.innerHTML = actionSaveButton.innerHTML.trim() + '<i class="' + evo.style.icon_plus + '"></i><span class="save-join">+</span>' + actionStay['stay' + actionSelect.value] + '<span>' + actionSelect.children['stay' + actionSelect.value].innerHTML + '</span>';
        }
