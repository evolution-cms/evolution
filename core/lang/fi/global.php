...
$_lang["chunk_assigned_file"] = 'Vastaava chunk-tiedosto';
$_lang["chunk_file_unusable_name"] = 'tästä nimestä ei voi tulla tiedostonimeä';
$_lang["chunk_file_not_writable"] = 'Chunk-tiedostoa %s ei voitu kirjoittaa, joten mitään ei tallennettu. Tarkista nimi ja chunk-hakemiston oikeudet.';
$_lang["chunk_name_empty"] = 'Tiedostossa säilytettävä chunk tarvitsee nimen.';
$_lang["chunk_name_not_utf8"] = 'Tämä nimi ei ole kelvollista UTF-8:aa, joten siitä ei voi tulla tiedostonimeä.';
$_lang["chunk_name_not_nfc"] = 'Tämä nimi käyttää yhdistäviä merkkejä. Kirjoita se uudelleen, tai macOS pitää sitä samana tiedostona kuin saman sanan toista kirjoitusasua.';
$_lang["chunk_name_too_long"] = 'Tämä nimi on liian pitkä tiedostonimeksi, kun sen erikoismerkit on suojattu.';
$_lang["chunk_name_collides"] = 'Tämä nimi ja chunk ”%s” jakaisivat saman tiedoston Windowsissa ja macOS:ssä, jotka erottavat ne vain kirjainkoosta. Nimeä toinen uudelleen.';
