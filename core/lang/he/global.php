...
$_lang["chunk_assigned_file"] = 'קובץ מיני התבנית המתאים';
$_lang["chunk_file_unusable_name"] = 'שם זה אינו יכול להיות שם קובץ';
$_lang["chunk_file_not_writable"] = 'לא ניתן היה לכתוב את קובץ מיני התבנית %s, ולכן דבר לא נשמר. בדקו את השם ואת ההרשאות של תיקיית מיני התבניות.';
$_lang["chunk_name_empty"] = 'למיני תבנית הנשמרת בקובץ דרוש שם.';
$_lang["chunk_name_not_utf8"] = 'שם זה אינו UTF-8 תקין, ולכן אינו יכול להיות שם קובץ.';
$_lang["chunk_name_not_nfc"] = 'שם זה משתמש בתווים משולבים. הקלידו אותו מחדש, אחרת macOS יתייחס אליו כאל אותו קובץ ככתיב אחר של אותה מילה.';
$_lang["chunk_name_too_long"] = 'שם זה ארוך מדי לשם קובץ לאחר שהתווים המיוחדים שבו מקודדים.';
$_lang["chunk_name_collides"] = 'שם זה ומיני התבנית "%s" היו חולקים קובץ אחד ב-Windows וב-macOS, המבחינים ביניהם רק לפי אותיות גדולות וקטנות. שנו את שמו של אחד מהם.';
