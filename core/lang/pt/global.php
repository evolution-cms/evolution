...
$evo_lang_attribute = 'pt'; // Manager HTML/XML Language Attribute see http://en.wikipedia.org/wiki/ISO_639-1
...
$_lang["chunk_assigned_file"] = 'Ficheiro do Chunk correspondente';
$_lang["chunk_file_unusable_name"] = 'este nome não pode ser um nome de ficheiro';
$_lang["chunk_file_not_writable"] = 'Não foi possível escrever o ficheiro do Chunk %s, por isso nada foi guardado. Verifique o nome e as permissões do diretório dos Chunks.';
$_lang["chunk_name_empty"] = 'Um Chunk guardado num ficheiro precisa de um nome.';
$_lang["chunk_name_not_utf8"] = 'Este nome não é UTF-8 válido, por isso não pode ser um nome de ficheiro.';
$_lang["chunk_name_not_nfc"] = 'Este nome usa caracteres combinantes. Escreva-o de novo, caso contrário o macOS tratá-lo-á como o mesmo ficheiro que outra grafia da mesma palavra.';
$_lang["chunk_name_too_long"] = 'Este nome é demasiado longo para um nome de ficheiro depois de os caracteres especiais serem escapados.';
$_lang["chunk_name_collides"] = 'Este nome e o Chunk «%s» partilhariam um mesmo ficheiro no Windows e no macOS, que apenas os distinguem por maiúsculas e minúsculas. Mude o nome de um deles.';
