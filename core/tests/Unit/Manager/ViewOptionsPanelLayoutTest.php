...
test('manage elements view options panel has scoped spacing rules', function () {
    ...
    expect($helper)
        ...
        ->and($mainCss)
        ->toContain('.switchForm { display: flex; flex-wrap: wrap; align-items: center; padding: 0.5rem 0;')
        ->toContain('.switchForm .form-row { display: flex; flex: 0 1 auto; flex-wrap: wrap; align-items: center; margin: 0 1rem 0.25rem 0;')
