...
$_lang["pwd_repair_minutes_message"] = 'پیوند بازیابی رمز عبور پس از ارسال چند دقیقه معتبر می‌ماند. برای اینکه پیوندها هرگز منقضی نشوند، 0 وارد کنید. لطفاً این مقدار را فقط به صورت عدد وارد کنید (بدون کاما، فاصله و غیره)';
$_lang["forgot_password_email_valid_until"] = 'این پیوند یک‌بار مصرف است و تا :datetime معتبر است.';
$_lang["forgot_password_email_valid_unlimited"] = 'این پیوند یک‌بار مصرف است و منقضی نمی‌شود.';
...
$_lang["chunk_assigned_file"] = 'فایل چانک متناظر';
$_lang["chunk_file_unusable_name"] = 'این نام نمی‌تواند نام فایل باشد';
$_lang["chunk_file_not_writable"] = 'فایل چانک %s نوشته نشد، بنابراین چیزی ذخیره نشد. نام و مجوزهای پوشهٔ چانک‌ها را بررسی کنید.';
$_lang["chunk_name_empty"] = 'چانکی که در یک فایل نگهداری می‌شود به نام نیاز دارد.';
$_lang["chunk_name_not_utf8"] = 'این نام UTF-8 معتبر نیست، بنابراین نمی‌تواند نام فایل باشد.';
$_lang["chunk_name_not_nfc"] = 'این نام از نویسه‌های ترکیبی استفاده می‌کند. آن را دوباره تایپ کنید، وگرنه macOS آن را همان فایلِ املای دیگری از همان واژه در نظر می‌گیرد.';
$_lang["chunk_name_too_long"] = 'این نام پس از گریز دادن نویسه‌های ویژه، برای نام فایل بسیار بلند است.';
$_lang["chunk_name_collides"] = 'این نام و چانک «%s» در ویندوز و macOS یک فایل مشترک می‌شدند، چون آن‌ها را فقط با بزرگی و کوچکی حروف تشخیص می‌دهند. نام یکی از آن‌ها را تغییر دهید.';
...
$_lang["module_exec_disabled"] = 'این ماژول غیرفعال است و نمی‌تواند اجرا شود.';
...
$_lang["login_processor_password_recovery"] = 'رمز عبور ذخیره‌شده این حساب قابل بررسی نیست. پیوندی برای تعیین رمز عبور جدید به نشانی ایمیل حساب ارسال شد.';
$_lang["login_processor_hash_expired"] = 'این پیوند بازیابی رمز عبور دیگر معتبر نیست. لطفاً پیوند جدیدی درخواست کنید.';
$_lang["login_processor_throttled"] = 'تلاش‌های ورود بیش از حد. لطفاً :seconds ثانیه دیگر دوباره تلاش کنید.';
...
$_lang["role_modules_tab"] = 'ماژول‌ها';
$_lang["role_modules_msg"] = 'ماژول‌هایی که این نقش اجازه اجرای آن‌ها را دارد. ماژولی که کسی آن را محدود نکرده باشد برای همه نقش‌ها در دسترس است؛ برداشتن تیک در اینجا آن را محدود می‌کند.';
$_lang["role_modules_admin_msg"] = 'نقش مدیر می‌تواند همه ماژول‌ها را اجرا کند.';
