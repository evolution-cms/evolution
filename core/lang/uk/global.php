...
$_lang["about_msg"] = 'Evolution CMS - це <a href="http://rtfm.modx.com/evolution/1.0/getting-started/what-is-modx" target="_blank">професійний інструмент розробки сайтів</a>, що дозволяє управляти контентом та поширюється за ліцензією <a href="../assets/docs/license.txt">GNU GPL</a>.';
...
$_lang["configcheck_cache_msg"] = 'Evolution CMS не в змозі записувати дані в папку кешування. Система буде працювати нормально, але кешування відбуватися не буде. Для вирішення проблеми дозвольте запис в папку <b>/assets/cache<b>.';
...
$_lang["modx_news"] = 'Новини Evolution CMS';
$_lang["modx_news_tab"] = 'Новини Evolution CMS';
$_lang["modx_news_title"] = 'Новини Evolution CMS';
...
$_lang["user_last_name"] = 'Фамілія';
$_lang["user_middle_name"] = 'Побатькові';
