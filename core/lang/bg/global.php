...
$evo_lang_attribute = 'bg'; // Manager HTML/XML Language Attribute see http://en.wikipedia.org/wiki/ISO_639-1
...
$_lang["chunk_assigned_file"] = 'Съответстващ файл на чънка';
$_lang["chunk_file_unusable_name"] = 'това име не може да стане име на файл';
$_lang["chunk_file_not_writable"] = 'Файлът на чънка %s не можа да бъде записан, затова нищо не беше запазено. Проверете името и правата на директорията с чънкове.';
$_lang["chunk_name_empty"] = 'Чънк, който се съхранява във файл, се нуждае от име.';
$_lang["chunk_name_not_utf8"] = 'Това име не е валиден UTF-8, затова не може да стане име на файл.';
$_lang["chunk_name_not_nfc"] = 'Това име използва комбиниращи знаци. Въведете го отново, иначе macOS ще го приеме за същия файл като друг изпис на същата дума.';
$_lang["chunk_name_too_long"] = 'Това име е твърде дълго за име на файл, след като специалните му знаци бъдат екранирани.';
$_lang["chunk_name_collides"] = 'Това име и чънкът „%s“ биха споделяли един файл под Windows и macOS, които ги различават само по големина на буквите. Преименувайте един от тях.';
...
$_lang['time_unit_second_short'] = 'сек';
