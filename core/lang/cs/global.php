...
$_lang["chunk_assigned_file"] = 'Odpovídající soubor chunku';
$_lang["chunk_file_unusable_name"] = 'z tohoto názvu nelze udělat název souboru';
$_lang["chunk_file_not_writable"] = 'Soubor chunku %s se nepodařilo zapsat, takže se nic neuložilo. Zkontrolujte název a práva adresáře chunků.';
$_lang["chunk_name_empty"] = 'Chunk uložený v souboru potřebuje název.';
$_lang["chunk_name_not_utf8"] = 'Tento název není platné UTF-8, takže z něj nelze udělat název souboru.';
$_lang["chunk_name_not_nfc"] = 'Tento název používá kombinující znaky. Napište jej znovu, jinak jej macOS bude považovat za stejný soubor jako jiný zápis téhož slova.';
$_lang["chunk_name_too_long"] = 'Tento název je po escapování speciálních znaků příliš dlouhý na název souboru.';
$_lang["chunk_name_collides"] = 'Tento název a chunk „%s“ by na Windows a macOS sdílely jeden soubor, protože je rozlišují jen podle velikosti písmen. Jeden z nich přejmenujte.';
